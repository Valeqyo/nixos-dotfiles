...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("playerctl next"),       { locked = true })
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("playerctl previous"),   { locked = true })
